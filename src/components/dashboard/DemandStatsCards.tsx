  ...
  return (
    <div className="grid grid-cols-3 gap-2 sm:gap-4">
      ...
      <button
        ...
        className={`min-h-[72px] sm:min-h-0 rounded-xl border bg-card p-3 sm:p-4 text-center transition-all hover:bg-accent/50 focus:outline-none focus-visible:ring-2 focus-visible:ring-ring active:scale-[0.98] ${filterStatus === "concluido" ? "ring-2 ring-[hsl(var(--success))] border-[hsl(var(--success))] shadow-sm" : "border-border"}`}
      >
